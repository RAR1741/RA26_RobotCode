...
public class LimelightSystem {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        DoubleArrayEntry poseEntry = LimelightSystem.getLimelightDoubleArrayEntry(limelightName, entryName);
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightSystem.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightSystem.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightSystem.LimelightResults results = new LimelightSystem.LimelightResults();
        if (mapper == null) {
